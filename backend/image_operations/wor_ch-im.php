...
$no = $_SESSION['no'];
$stmt = $_SESSION['stmt'];
$que = "If ".$word." is present in given statement \nthen press ".$yes." else, press ".$no." \nThe words are: ".$stmt;
#echo $stmt;
...
imagecopyresized($img1, $img, 0, 0, 0, 0, 800, 600, $width, $height);
if($randomBgColor == 0){
...
imagettftext($img1, 30, 0, 30, 40, $text_color, $font, $que);
imagepng($img1);
imagedestroy($img1);
?>
